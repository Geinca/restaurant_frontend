...
const Menu = () => {
    return (
        <div className={style.menu}>
            <Link to={'/new'} className={style.btn}><button>Add new discs</button></Link>
                ...
                <Grid container lg={12} sm={12} direction="row" justifyContent="center" spacing={6} className={style.Grid1}>
                    <Grid item lg={3} sm={6} textAlign="center" className={style.secson}>
                        <Card style={{ height: "100%", width: "90%", padding: "10px", border: "3px solid green", boxShadow: "0px 0px 20px black", backgroundColor: "rgba(0, 0, 0, 0.5)" }}>
                            <img src="https://www.foodiesfeed.com/wp-content/uploads/2023/06/burger-with-melted-cheese.jpg" alt="" width="50%" height="60%" marginTop="20px" />
                            <Grid style={{ display: "flex", height: "35px", justifyContent: "space-around", alignItems: "center" }}>
                                ...
                                <Grid style={{ height: "100%", width: "40%", marginLeft: "20px", border: "2px solid gold", backgroundColor: "rgba(0, 0, 0, .3)", marginTop: "20px", display: "flex", alignItems: "center", justifyContent: "space-evenly", borderRadius: "5px" }}>
                                    ...
                                    <Link to={'/edit'}><button style={{ color: "white", fontWeight: "700", height: "100%", width: "100%", backgroundColor: "transparent", border: "none", borderRadius: "3px" }}>Edit</button></Link>
                                </Grid>
                                <Grid style={{ height: "100%", width: "40%", marginLeft: "20px", border: "2px solid gold", backgroundColor: "rgba(0, 0, 0, .3)", marginTop: "20px", display: "flex", alignItems: "center", justifyContent: "space-evenly", borderRadius: "5px" }}>
                                    <button style={{ color: "white", fontWeight: "700", height: "100%", width: "100%", backgroundColor: "transparent", border: "none", borderRadius: "3px" }}>Delete</button>
                    ...
                    <Grid item lg={3} sm={6} textAlign="center" className={style.secson}>
                        <Card style={{ height: "100%", width: "90%", padding: "10px", border: "3px solid green", boxShadow: "0px 0px 20px black", backgroundColor: "rgba(0, 0, 0, 0.5)" }}>
                            <img src="https://www.foodiesfeed.com/wp-content/uploads/2023/06/burger-with-melted-cheese.jpg" alt="" width="50%" height="65%" marginTop="20px" />
                            <Grid style={{ display: "flex", height: "35px", justifyContent: "space-around", alignItems: "center" }}>
                                <h1 style={{ color: "goldenrod", paddingBottom: "-70px", marginTop: "20px" }}>Burger</h1>
                                <Grid style={{ height: "100%", width: "40%", marginLeft: "20px", border: "2px solid gold", backgroundColor: "rgba(0, 0, 0, .3)", marginTop: "20px", display: "flex", alignItems: "center", justifyContent: "space-evenly", borderRadius: "5px" }}>
                                    <Link to={'/edit'}><button style={{ color: "white", fontWeight: "700", height: "100%", width: "100%", backgroundColor: "transparent", border: "none", borderRadius: "3px" }}>Edit</button></Link>
                    ...
                    <Grid item lg={4} sm={6} textAlign="center" className={style.secson}>
                        <Card style={{ height: "100%", width: "90%", padding: "10px", border: "3px solid green", boxShadow: "0px 0px 20px black", backgroundColor: "rgba(0, 0, 0, 0.5)" }}>
                            <img src="https://www.foodiesfeed.com/wp-content/uploads/2023/06/burger-with-melted-cheese.jpg" alt="" width="50%" height="65%" marginTop="20px" />
                            <Grid style={{ display: "flex", height: "35px", justifyContent: "space-around", alignItems: "center" }}>
                                <h1 style={{ color: "goldenrod", paddingBottom: "-70px", marginTop: "20px" }}>Burger</h1>
